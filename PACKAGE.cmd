...
if not exist "%ROOT%scripts\Package.ps1" (
  ...
  echo Extract the source ZIP completely before running PACKAGE.cmd.
  pause
  exit /b 2
)
echo Creating shareable Revit Model Health Check distribution package...
...
if "%EC%"=="0" echo DISTRIBUTION PACKAGE CREATED SUCCESSFULLY.
pause
exit /b %EC%
